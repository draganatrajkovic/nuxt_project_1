<template>
    <div class="box__wrap box__wrap--padding box__wrap--team">
        <div class="box box--column">
            <h1 class="title text--center">A team plugged into yours </h1>
...
<script>
import BlockTeamWorker from './BlockTeamWorker'
